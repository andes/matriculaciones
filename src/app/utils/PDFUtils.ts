...
export class PDFUtils {
    ...
    public certificadoDeEticaConEspecialidad(profesional, grado) {
        ...
        doc.setFontStyle('bold');
        doc.text('Por pedido del interesado/a, a los fines que hubiere lugar, se extiende el presente, en Neuquén', 8, offsetLoop + 108);
        doc.text('a los ' + hoy.getDate() + ' días del mes de ' + mes + ' de ' + hoy.getFullYear() + '.', 8, offsetLoop + 113);
        doc.setFontStyle('normal');
        doc.text('EL PRESENTE CERTIFICADO TIENE VALIDEZ POR EL TERMINO DE 30 (TREINTA) DIAS.', 8, offsetLoop + 118);
    ...
    public comprobanteTurnoDesdeProf(turno: any, grado, tipoMatricula): any {
        ...
        const hoy = new Date();
        const img = 'data:image/jpeg;base64,';
        doc.addImage(img, 'jpg', 20, 5, 40, 30);
        ...
        // Completado
        doc.setFont('courier');
        doc.text(65, 65, turno.apellido);
        doc.text(65, 71, turno.nombre);
        doc.text(65, 77, 'DNI ' + turno.documento);
        doc.text(65, 83, this.getSimpleFormatedDate(turno.fechaNacimiento));
